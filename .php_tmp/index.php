  ...
  <div class="container">
    ...
    <form action="send.php" method="post" id="myForm" class="grid grid-cols-1 w-1/2 ml-[50%] mt-60">
      ...
      <div class="mb-4">
        ...
        <input type="email" name="email" placeholder="Email" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
      </div>
      <div class="mb-4">
      ...
      <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" type="submit" onclick="sendEmail('Sended')">Send</button>
    </form>
  </div>
